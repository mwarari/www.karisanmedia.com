...
$params = array();
$params["title"] = "Karisan Media Chat";
...
$params["debug"] = false;
$params["height"] = "240";
$channels = array('Live Chat');
$params["channels"] = $channels;
$admins = array();
$admins = array('karisan media' => 'letmein10');
$params["admins"] = $admins;
$chat = new phpFreeChat( $params );
$params['max_msg'] = "0"; // Clear chat for all new users.
...
<html>
 <head>
  ...
  <title>Karisan Media Productions Chat</title>
