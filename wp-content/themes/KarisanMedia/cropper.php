...
function mime_type($file) {
    ...
    if(!valid_src_mime_type($mime_type) && !(preg_match('/windows/i', $os))) { // 09/28/2012 - Replaced deprecated function eregi()
...
function get_cache_file () {
	...
	static $cache_file;
	if(!$cache_file) {
		$frags = preg_split( "/\./", $_REQUEST['src'] ); // 09/28/2012 - Replaced deprecated function split()
