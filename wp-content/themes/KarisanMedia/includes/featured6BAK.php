				...
				<div class="tierxcontent">
						...
						<?php $thecimage = get_image_for_crop($post->ID,$thumborno=1);
									...
									if (isset($thecimage) && !empty($thecimage)) { ?>
										...
										<div class="tierximage"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e("Permanent Link to",'KarisanMediaTheme');?> <?php the_title_attribute(); ?>"><img src="<?php echo bloginfo('template_url'); ?>/<?php echo $cropperfile;?>?src=<?php echo $thecimage; ?>&amp;h=150&amp;w=150&amp;zc=1&amp;q=95" alt="<?php the_title(); ?>" /></a></div>
