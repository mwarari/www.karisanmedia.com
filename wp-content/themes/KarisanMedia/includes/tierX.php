...
<div class="widget">
			<h2><?php if(get_option($themeoptionsprefix.'_rsssubscribeblockh2') <> ""){ echo get_option($themeoptionsprefix.'_rsssubscribeblockh2'); } else { _e("Get our latest updates","KarisanMediaTheme"); } ?></h2>
			...
			<?php if(get_option($themeoptionsprefix.'_rsssubscribeblocklinktext') <> ""){ echo get_option($themeoptionsprefix.'_rsssubscribeblocklinktext'); } else { _e("Subscribe Via A Feed Reader","KarisanMediaTheme"); } ?>
				</a></p>

		<?php if(get_option($themeoptionsprefix.'_feedburnerid') <> ""){ ?>

				<p>
				<?php if(get_option($themeoptionsprefix.'_rsssubscribeblocksubtext') <> ""){ echo get_option($themeoptionsprefix.'_rsssubscribeblocksubtext'); } else { _e("Sign up via email to receive breaking news as well as receive other site updates","KarisanMediaTheme"); } ?>
				...
				<?php _e("Enter your email address","KarisanMediaTheme");?>:<br/><input type="text" style="width:140px" name="email"/></p><input type="hidden" value="<?php $feedburner_id = get_option($themeoptionsprefix.'_feedburnerid'); echo $feedburner_id; ?>" name="uri"/><input type="hidden" name="loc" value="en_US"/><input type="submit" value="<?php _e("Subscribe","KarisanMediaTheme");?>" /><p><?php _e("Delivered by","KarisanMediaTheme");?> <a href="http://feedburner.google.com" target="_blank">FeedBurner</a></p></form>
...
<?php } ?>
			...
			<div class="widget">
				<h2><?php _e("Recent Posts","KarisanMediaTheme"); ?></h2>
				<ul>
