...
<?php if ( have_comments() || 'open' == $post->comment_status) :?>
	<h3 id="comments-wrap" class="info"><?php comments_number(__('No Comments'), __('One Comments'), __('% Comments') );?> <?php _e('to');?> &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	<p>Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="Log out of this account">Log out &raquo;</a></p>
		...
		<p>
		<input name="submit" id="submit" type="submit" tabindex="5" value="<?php _e('submit'); ?>" class="button" />
