...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('<?php bloginfo('stylesheet_directory'); ?>/library/picker.html', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
